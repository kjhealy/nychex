...
A tessellated square tile map of all 2,325 New York City 2020 census
tracts. Each tract is represented by a single square polygon tile,
...
`square = TRUE`, applied to each borough separately (Manhattan, Bronx,
...
square map, Brooklyn and Queens were tiled as separate boroughs rather
