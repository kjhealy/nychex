...
hexagonal polygon tile, arranged to approximate the geographic layout of
the city.
...
The hex map was generated using the tilemaps algorithm applied to
borough groups separately (Manhattan, Bronx, Brooklyn/Queens, Staten
Island), then rescaled to uniform hex size and assembled to preserve
NYC's overall geographic layout. Island NTAs were added back using
