...
nyc_nta_boros_sq_sf <- nyc_nta20_sq_sf |>
  ...
  st_set_crs(st_crs(nyc_nta20_sq_sf)) |>
  arrange(boro_code)

saveRDS(nyc_nta_boros_sq_sf, here::here("data-raw", "sq_boro_outlines.rds"))

usethis::use_data(nyc_nta_boros_sq_sf, overwrite = TRUE, compress = "xz")
