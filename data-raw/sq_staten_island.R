...
## SI9591 — southeast of Staten Island
si9591_pos <- c(si_bbox["xmax"] + hex_spacing, si_bbox["ymin"])
...
saveRDS(si_sq_sf, here::here("data-raw", "sq_staten_island.rds"))
...
p <- ggplot(si_sq_sf) +
  ...
  labs(title = "Staten Island NTA 2020 Square Map") +
  theme_void()

ggsave(
  here::here("data-raw", "sample-figures", "staten_island_sq.png"),
