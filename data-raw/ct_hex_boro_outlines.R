...
nyc_ct_boros_hex_sf <- nyc_ct20_hex_sf |>
  ...
  st_set_crs(st_crs(nyc_ct20_hex_sf)) |>
  arrange(boro_code)

saveRDS(nyc_ct_boros_hex_sf, here::here("data-raw", "ct_hex_boro_outlines.rds"))

usethis::use_data(nyc_ct_boros_hex_sf, overwrite = TRUE, compress = "xz")
