...
#'
#' A tessellated hexagonal tile map of all 2,325 New York City 2020
#' census tracts. Each tract is represented by a single hexagonal
...
#' disconnected after polygon simplification) are included as individual
...
#' Tabulation Areas (NTA 2020). Each NTA is represented by a single
#' square polygon tile, arranged to approximate the geographic layout
#' of the city.
#'
#' @format ## `nyc_nta20_sq_sf`
#' A simple feature collection with 262 rows and 12 columns:
#' \describe{
#'   \item{boro_code}{Borough code. 1 = Manhattan, 2 = Bronx,
#'     3 = Brooklyn, 4 = Queens, 5 = Staten Island.}
...
#'   \item{nta_abbrev}{Abbreviated NTA name.}
#'   \item{shape_area}{Area of the original NTA boundary.}
#'   \item{tile_map}{POLYGON square tile geometry (EPSG:2263).}
#' }
#'
#' @details
#' The square tile map was generated using the
#' [tilemaps][tilemaps::generate_map] algorithm with `square = TRUE`,
...
#' borough, derived from [nyc_nta20_sq_sf]. Disconnected island tiles are
#' excluded. Brooklyn and Queens have separate outlines, so the shared
#' border between them is visible.
#'
#' @format ## `nyc_nta_boros_sq_sf`
#' A simple feature collection with 5 rows and 3 columns:
#' \describe{
#'   \item{boro_name}{Borough name.}
#'   \item{boro_code}{Borough code. 1 = Manhattan, 2 = Bronx,
...
#'
#' @author Kieran Healy
#' @source Derived from [nyc_nta20_sq_sf] by unioning square tiles per
#'   borough and extracting the largest polygon.
"nyc_nta_boros_sq_sf"
...
#' Borough outlines for the NYC census tract 2020 square tile map
#'
#' Polygon outlines of the main contiguous square tile area for each NYC
#' borough, derived from [nyc_ct20_sq_sf]. Disconnected island tiles are
#' excluded. Brooklyn and Queens have separate outlines, so the shared
#' border between them is visible.
#'
#' @format ## `nyc_ct_boros_sq_sf`
#' A simple feature collection with 5 rows and 3 columns:
#' \describe{
#'   \item{boro_name}{Borough name.}
#'   \item{boro_code}{Borough code. 1 = Manhattan, 2 = Bronx,
...
#'
#' @author Kieran Healy
#' @source Derived from [nyc_ct20_sq_sf] by unioning square tiles per
#'   borough and extracting the largest polygon.
"nyc_ct_boros_sq_sf"
